<x-layout>
    <div class="max-w-4xl mx-auto p-6">
        ...
        <div class="flex flex-col lg:flex-row">
            ...
            <div class="lg:w-1/2 lg:pl-6">
                ...
                <div class="mt-6">
                    ...
                    <div class="mt-4">
                        <a href="{{ route('product.edit', ['product' => $product->id]) }}"><button
                                class="px-4 py-2 bg-green-500 text-white rounded-lg">Edit
                                Product</button></a>
        ...
        <!-- Back Button -->
        <div class="mt-6">
            <a href="#" class="inline-block px-4 py-2 bg-blue-500 text-white rounded-lg">Back to Products</a>
        </div>
    </div>
</x-layout>
